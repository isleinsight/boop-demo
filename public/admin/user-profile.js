...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function ensurePassportSection() {
    // If you added the static HTML block, this simply returns it.
    let section = document.getElementById("passportSection");
    if (section) return section;

    // Otherwise, inject a section just before Transaction History.
  ...
  async function loadPassport(userId) {
    ...
    try {
      ...
      // Reset listener to avoid duplicates when page reloads
...
`;
      ...
      // Passport Tap Link (populate section)
